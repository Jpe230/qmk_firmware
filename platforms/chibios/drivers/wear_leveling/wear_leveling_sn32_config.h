...
#ifndef WEAR_LEVELING_SN32_EMULATION_FLASH_SIZE
#    if defined(QMK_MCU_SERIES_SN32F240B)
#        define WEAR_LEVELING_SN32_EMULATION_FLASH_SIZE 64
#    elif defined(QMK_MCU_SERIES_SN32F260)
#        define WEAR_LEVELING_SN32_EMULATION_FLASH_SIZE 30
#    endif
#endif
...
#    define WEAR_LEVELING_SN32_EMULATION_BASE_PAGE_ADDRESS ((uint32_t)(WEAR_LEVELING_SN32_PAGE_SIZE * WEAR_LEVELING_SN32_EMULATION_TOTAL_PAGE - ((WEAR_LEVELING_SN32_EMULATION_PAGE_COUNT + 1) * WEAR_LEVELING_SN32_PAGE_SIZE))) // 64000 for 248
#endif
...
#    define WEAR_LEVELING_LOGICAL_SIZE (WEAR_LEVELING_SN32_EMULATION_PAGE_COUNT * WEAR_LEVELING_SN32_PAGE_SIZE)
#endif
